...
// CREATION LIAISON ENTRE STORE ET LOCALSTORAGE (BROWSER) + CREATION SOUSCRIPTIONS (~~FLUX RSS)
//Soit on a infos local Storage, soit on n'en a pas et on va les chercher dans le store
